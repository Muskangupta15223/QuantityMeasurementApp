...
## **UC17: Migration to Spring Boot with REST APIs, JPA, Security & Testing**

### **What we did:**
- Migrated application to **Spring Boot**
- Replaced manual wiring with **Spring Dependency Injection**
- Converted application into **RESTful APIs using @RestController**
- Integrated **Spring Data JPA** for database operations
- Added **Spring Security** with Basic Authentication
- Enabled **Swagger (OpenAPI)** for API documentation
...
- Wrote **unit and integration tests using MockMvc**
...
public ResponseEntity<?> compare(@RequestBody QuantityInputDTO input) {
    return ResponseEntity.ok(service.compareQuantities(
